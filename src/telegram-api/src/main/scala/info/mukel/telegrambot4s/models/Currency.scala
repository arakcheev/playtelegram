...
object Currency extends Enumeration {
  ...
  val RUB = TelegramCurrency(code = "RUB", title = "Russian Ruble", symbol = "RUB", native = "руб.", thousandsSep = " ", decimalSep = ",", symbolLeft = false, spaceBetween = true, exp = 2, minAmount = 5694, maxAmount = 57040501)
